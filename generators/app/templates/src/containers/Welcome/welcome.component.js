...
import { UI_WELCOME } from "@inrupt/lit-generated-vocab-inrupt-ui-component";
 ...
 * Image component will get the image context and resolve the value to render.
 * @param props
 */
    ...
    <WelcomeWrapper data-testid="welcome-wrapper">
      <WelcomeCard className="card">
        ...
        <WelcomeProfile data-testid="welcome-profile">
          <h3>
            {UI_WELCOME.welcome.message}, <WelcomeName>{name}</WelcomeName>
      ...
      <WelcomeCard className="card">
        <WelcomeDetail data-testid="welcome-detail">
          <Trans t={() => UI_WELCOME.title.message}>
          ...
          <Trans t={() => UI_WELCOME.evolvingMessage.message}>
          ...
          <Trans i18nKey="welcome.fairUsageExamples">
            <ul>
              <li>
                If your application is Solid compatible, you can use the Solid
                logo to indicate that. If not, please don’t misrepresent
                yourself by using the Solid logo.
              </li>
              <li>
                Please don't use the Inrupt name as a part of your company name,
                website name, domain name, service name, or app name. Don't use
                our logo as your own or modify it to fit into your own logo.
              </li>
              <li>
                If you’d like, you may use the Inrupt logo to indicate that your
                application is powered by Inrupt’s SDK, but please make sure the
                context is clear to the user. Your own logo should always be
                larger than Inrupt’s logo, for example.
              </li>
            </ul>
          </Trans>
          ...
          <Trans i18nKey="welcome.contactUsText">
            <p>
              If you have additional questions about the use of the React SDK
              for Solid, the Application Generator, or Inrupt’s brand, please
              contact
